...
export name='eduuardo1357'
export email="eduardo.silva1077@etec.sp.gov.br"
export repositorio="https://github.com/eduuardo1357/javaScript-Alert-comfirm-Promt.git";
